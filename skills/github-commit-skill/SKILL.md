...
```powershell
# Navigate to your user root (works on any machine)
cd "$env:USERPROFILE"

# Download the repo from GitHub
# This creates a folder called "content-automation" here
...
Note: the repo clones into `C:\Users\noahg\content-automation` on this
machine since the OneDrive Desktop path is non-standard. Always run
cleanup from `$env:USERPROFILE`, not from the Desktop.
